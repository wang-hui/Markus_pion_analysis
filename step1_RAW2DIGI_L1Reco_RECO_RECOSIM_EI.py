...
# with command line options: step1 --mc --eventcontent RECOSIM,AODSIM --runUnscheduled --datatier GEN-SIM-RECO,AODSIM --conditions 106X_upgrade2018_realistic_v11_L1v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --nThreads 4 --geometry DB:Extended --era Run2_2018 --filein file:DIGI.root --fileout file:RECO.root
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:RECO_inAODSIM.root'),
