...
# with command line options: step1 --mc --eventcontent RAWSIM --runUnscheduled --pileup NoPileUp --datatier GEN-SIM-DIGI --conditions 106X_upgrade2018_realistic_v11_L1v1 --step DIGI,L1,DIGI2RAW --nThreads 4 --geometry DB:Extended --era Run2_2018 --filein file:GEN-SIM.root --fileout file:DIGI.root
